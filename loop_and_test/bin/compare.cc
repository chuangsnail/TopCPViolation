/**********************************************************************************/
//	This is updated on 190515 by cychuang 
...
int main()
{
	...
	*/
	...
	TH1F* h_TT_mu = new TH1F("h_TT_mu","",45,0.,600.);
	TH1F* h_TT_el = new TH1F("h_TT_el","",45,0.,600.);
	...
	TH1F* h_DY_mu = new TH1F("h_DY_mu","",45,0.,600.);
	TH1F* h_DY_el = new TH1F("h_DY_el","",45,0.,600.);
	...
	TH1F* h_WJets_mu = new TH1F("h_WJets_mu","",45,0.,600.);
	TH1F* h_WJets_el = new TH1F("h_WJets_el","",45,0.,600.);
	...
	TH1F* h_VV_mu = new TH1F("h_VV_mu","",45,0.,600.);
	TH1F* h_VV_el = new TH1F("h_VV_el","",45,0.,600.);
...
*/
	TH1F* h_ST_mu = new TH1F("h_ST_mu","",45,0.,600.);
	TH1F* h_ST_el = new TH1F("h_ST_el","",45,0.,600.);
	...
	/*
	TH1F* h_QCD_mu = new TH1F("h_QCD_mu","",45,0.,600.);
	TH1F* h_QCD_el = new TH1F("h_QCD_el","",45,0.,600.);
	...
	*/
	...
	TH1F* h_Data_mu = new TH1F("h_Data_mu"," ;hadronic top mass(GeV);Events(No.)",45,0.,600.);	//"(primary title);(X-Axis title);(Y-Axis Title)"
	TH1F* h_Data_el = new TH1F("h_Data_el"," ;hadronic top mass(GeV);Events(No.)",45,0.,600.);
	...
	Plot_MCData(h_Data_mu,h_MCs_mu,"Muon_Channel",hist_name,text_mu);

	Plot_MCData(h_Data_el,h_MCs_el,"Electron_Channel",hist_name,text_el);
