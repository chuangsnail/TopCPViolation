 ...
 *	Description : use train_13's ANN result with variable mass.
 *	Date : 191106~
...
int main(int argc,char* argv[])
{
	...
	vector<TH1F*> h_el_cc;
	h_el.push_back(h_TT_el_cc);		h_el.push_back(h_DY_el_cc);
	h_el.push_back(h_WJets_el_cc);		h_el.push_back(h_VV_el_cc);
	h_el.push_back(h_ST_el_cc);		h_el.push_back(h_QCD_el_cc);
	h_el.push_back(h_Data_el_cc);
	...
	string new_file_name = "SR_t13_MLP_all_" + time + ".root";
