...
def main(args):
    ...
    ch   = TChain( "root" )
    ch.Add( "/wk_cms2/cychuang/2016legacy_dbl_pre_sel_file/WJets/WJetsToLNu_HT-100To200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/pre_sel_bpk_ntuple_*.root" )
    ch.Add( "/wk_cms2/cychuang/2016legacy_dbl_pre_sel_file/WJets/WJetsToLNu_HT-1200To2500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/pre_sel_bpk_ntuple_*.root" )
    ch.Add( "/wk_cms2/cychuang/2016legacy_dbl_pre_sel_file/WJets/WJetsToLNu_HT-200To400_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/pre_sel_bpk_ntuple_*.root" )
    ch.Add( "/wk_cms2/cychuang/2016legacy_dbl_pre_sel_file/WJets/WJetsToLNu_HT-2500ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/pre_sel_bpk_ntuple_*.root" )
    ch.Add( "/wk_cms2/cychuang/2016legacy_dbl_pre_sel_file/WJets/WJetsToLNu_HT-400To600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/pre_sel_bpk_ntuple_*.root" )
    ch.Add( "/wk_cms2/cychuang/2016legacy_dbl_pre_sel_file/WJets/WJetsToLNu_HT-600To800_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/pre_sel_bpk_ntuple_*.root" )
    ch.Add( "/wk_cms2/cychuang/2016legacy_dbl_pre_sel_file/WJets/WJetsToLNu_HT-70To100_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/pre_sel_bpk_ntuple_*.root" )
    ch.Add( "/wk_cms2/cychuang/2016legacy_dbl_pre_sel_file/WJets/WJetsToLNu_HT-800To1200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/pre_sel_bpk_ntuple_*.root" )
