/**************************************************************************************
 *
 *	File Name : cor_mva_chi2_t08_MLP.cc
 *	Description : for train_05
 *	Date : 190930~
...
#include "/wk_cms2/cychuang/CMSSW_9_4_2/src/wk_mva/train_08/weights/TMVAClassification_BDTG.class.C"
...
int test_count = 0;
	...
	TH1F* h_max_mva_mu = new TH1F("h_max_mva_mu","",100,-1.,1.);
	TH1F* h_max_mva_cor_mu = new TH1F("h_max_mva_cor_mu","",100,-1.,1.);
	TH1F* h_max_mva_incor_mu = new TH1F("h_max_mva_incor_mu","",100,-1.,1.);
	...
	TH1F* h_max_mva_el = new TH1F("h_max_mva_el","",100,-1.,1.);
	TH1F* h_max_mva_cor_el = new TH1F("h_max_mva_cor_el","",100,-1.,1.);
	TH1F* h_max_mva_incor_el = new TH1F("h_max_mva_incor_el","",100,-1.,1.);
	...
	TH1F* h_max_mva_cor_t = new TH1F( "h_max_mva_cor_t","",100,-1.,1. );
	TH1F* h_max_mva_incor_t = new TH1F( "h_max_mva_incor_t","",100,-1.,1. );

	TH1F* h_min_chi2_cor_t = new TH1F( "h_min_chi2_cor_t","",100,0.,500. );
	TH1F* h_min_chi2_incor_t = new TH1F( "h_min_chi2_incor_t","",100,0.,500. );

	TH2D* h_mvamax_mass_mu = new TH2D("h_mvamax_mass_mu","",50,0.,500.,50,-1.,1.);
	TH2D* h_mvamax_mass_el = new TH2D("h_mvamax_mass_el","",50,0.,500.,50,-1.,1.);
		...
		for(int r=0;r<(int)files_map[ Set_name ]->size();r++)
		{
			...
			*/
			...
			for(int entry=0;entry<(int)t_entries;++entry)
			{
				...
				double MAX_mva_value = -5.;				//BDTG's value is -1~1
...
*/
	...
	string new_file_name = "cor_mva_chi2_t08_BDTG_" + time + ".root";
	...
	cout << "Error : " << (double) h_cor_el->GetBinError(2) << endl; 	
