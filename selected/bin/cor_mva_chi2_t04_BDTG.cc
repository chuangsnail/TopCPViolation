/**************************************************************************************
 *
 *	File Name : cor_mva_chi2_t04_BDTG.cc
...
#include "/wk_cms2/cychuang/CMSSW_9_4_2/src/wk_mva/train_04/weights/TMVAClassification_BDTG.class.C"
...
int test_count = 0;
	...
	TH1F* h_max_mva_mu = new TH1F("h_max_mva_mu","",50,0.,1.);
	TH1F* h_max_mva_cor_mu = new TH1F("h_max_mva_cor_mu","",50,0.,1.);
	TH1F* h_max_mva_incor_mu = new TH1F("h_max_mva_incor_mu","",50,0.,1.);
	...
	TH1F* h_max_mva_el = new TH1F("h_max_mva_el","",50,0.,1.);
	TH1F* h_max_mva_cor_el = new TH1F("h_max_mva_cor_el","",50,0.,1.);
	TH1F* h_max_mva_incor_el = new TH1F("h_max_mva_incor_el","",50,0.,1.);
	...
	TH1F* h_max_mva_cor_t = new TH1F( "h_max_mva_cor_t","",50,0.,1. );
	TH1F* h_max_mva_incor_t = new TH1F( "h_max_mva_incor_t","",50,0.,1. );
		...
		for(int r=0;r<(int)files_map[ Set_name ]->size();r++)
		{
			...
			*/
			...
			for(int entry=0;entry<(int)t_entries;++entry)
			{
				...
				double MAX_mva_value = -5.;				//BDT's value is 0~1
...
*/
	...
	string new_file_name = "cor_mva_chi2_t04_" + time + ".root";
