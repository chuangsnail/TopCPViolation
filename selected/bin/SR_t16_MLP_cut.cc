/**************************************************************************************
 *
 *	File Name : SR_t16_MLP_cut.cc
 *	Description : use train_16's ANN result with variable mass.
 *	Date : 191106~
...
int main(int argc,char* argv[])
{
	...
	string new_file_name = "SR_t13_MLP_cut_" + time + ".root";
