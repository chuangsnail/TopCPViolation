...
*/
	...
	f->GetObject("h_TT_mu_c",h_TT_mu);
	f->GetObject("h_DY_mu_c",h_DY_mu);
	f->GetObject("h_WJets_mu_c",h_WJets_mu);
	f->GetObject("h_VV_mu_c",h_VV_mu);
	f->GetObject("h_ST_mu_c",h_ST_mu);
	f->GetObject("h_QCD_mu_c",h_QCD_mu);
	f->GetObject("h_Data_mu_c",h_Data_mu);

	f->GetObject("h_TT_el_c",h_TT_el);
	f->GetObject("h_DY_el_c",h_DY_el);
	f->GetObject("h_WJets_el_c",h_WJets_el);
	f->GetObject("h_VV_el_c",h_VV_el);
	f->GetObject("h_ST_el_c",h_ST_el);
	f->GetObject("h_QCD_el_c",h_QCD_el);
	f->GetObject("h_Data_el_c",h_Data_el);
...
/*	
	if( !(std::string(argv[1]).find("SR") != string::npos ) ){
