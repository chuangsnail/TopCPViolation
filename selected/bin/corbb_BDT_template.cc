...
#include "/wk_cms2/cychuang/CMSSW_9_4_2/src/TopCPViolation/selected/interface/MVAvar.h"

#include "TopCPViolation/selected/interface/GenMgr.h"	//for cor
#include "/wk_cms2/cychuang/CMSSW_9_4_2/src/wk_mva/a04_all/weights/TMVAClassification_BDT.class.C"
...
{
	//*****prepare mva objects*****//
	//in the file interface/mvaclass.h
	string training_name = string("a04") + string("_BDT");
	...
	cout << "Finishing read datasets' weights and path" << endl;
...
*/	
	...
	Hists_bb histbb;
	histbb.SetAlgoBin(50,-1.,1.);
	histbb.Init();

	Hists_cor histcor;
	histcor.SetAlgoBin(50,-1.,1.);
	histcor.Init();
	...
	string new_file_name = string("cor_bbsep_") + training_name + "_" + time_str + string(".root");
