...
def main(args):
    ...
    ch   = TChain( "root" )
    ch.Add( "/wk_cms2/cychuang/2016legacy_pre_sel_file/TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8/pre_sel_bpk_ntuple_*.root" )
    print ">> Processing " + opt.sample 

    newfile = TFile( "/wk_cms2/cychuang/CMSSW_8_0_19/src/TopCPViolation/data/beffPlot_{}_{}.root".format( opt.sample, str(opt.discriminator).replace(".","pt") ), 'RECREATE' )
