...
/**************************************************************************************
 *
 *	File Name : bbsep_t17_MLP.cc
 *	Description : for train_17
 *	Date : 191105~
...
#include "/wk_cms2/cychuang/CMSSW_9_4_2/src/wk_mva/train_17/weights/TMVAClassification_MLP.class.C"
...
",t_entries);
	...
	string new_file_name = "bbsep_17_MLP_" + time + ".root";
